...
public class ProductoController {
    ...
    private void setDataInfo() {
        ...
        if (!producto.getPhoto().isBlank() && Files.exists(Paths.get(producto.getPhoto().replace("file:/", "")))) {
            ...
            producto.setPhoto(Resources.getPath(HelloApplication.class, "img/cajita.png"));
        }
    ...
    private boolean isDataOk() {
        ...
        if (productStock.getText() == null || productStock.getText().isBlank() || Utils.isNumberInt(productStock.getText())) {
        ...
        if (productPrice.getText() == null || productPrice.getText().isBlank() || Utils.isNumerDouble(productPrice.getText())) {
    ...
    private void onAcept() {
        ...
        if (isDataOk()) {
            ...
            producto.setPhoto(imageProd.getImage().getUrl().replaceFirst("file:/",""));
    ...
    private void onClickImg() {
        ...
        if (file != null) {
            ...
            producto.setPhoto(file.getAbsolutePath());
