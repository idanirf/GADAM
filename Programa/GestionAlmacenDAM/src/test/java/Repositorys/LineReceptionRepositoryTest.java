...
public class LineReceptionRepositoryTest {
    ...
    LineReception linereception = new LineReception("nuevo", 3, 30D, "pertenece a");
    ...
    public void saveTest() throws SQLException {
        ...
        ObservableList li = repository.SerachByReceptionsBelong(linereception.getBelongsRecepcion());
        int sice= li.size();
        LineReception lineR = new LineReception("otro", 3, 30D, "pertenece a");
        repository.save(lineR);
        ObservableList li2 = repository.SerachByReceptionsBelong(linereception.getBelongsRecepcion());
    ...
    public void updateTest() throws SQLException {
        ...
        repository.update(linereception, linereception.getRLIC());
    ...
    public void searchByUuidReception() throws SQLException {
        ObservableList<LineReception> res = repository.SerachByReceptionsBelong(linereception.getBelongsRecepcion());
        System.out.println(res.size());
        Optional<LineReception> l = res.stream().findFirst();
        System.out.println(l);
        ObservableList<LineReception> res2 = repository.SerachByReceptionsBelong(l.get().getBelongsRecepcion());
