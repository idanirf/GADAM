...
public class LineRecepcionRepository  implements LineRecepcionInterface{

    private static LineRecepcionRepository instance;
    private final DataBaseManager dataBaseManager;

    private LineRecepcionRepository(DataBaseManager dataBaseManager) {
        this.dataBaseManager = dataBaseManager;
    }

    public static LineRecepcionRepository getInstance(){
        if(instance==null){
            instance = new LineRecepcionRepository(DataBaseManager.getInstance());
        }
        return instance;
    }
    ...
    @Override
    public Optional SerachByReceptionBelongs(Object identifier) throws SQLException {
        dataBaseManager.open();
